...
const { getPeliculas, getIdPeliculas, getBusqueda, crearPelicula, actualizarPelicula, borrarPelicula, subirCaratula, retornaImgen } = require('../controllers/peliculas');
